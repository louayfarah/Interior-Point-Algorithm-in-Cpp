...
void interiorPointAlgorithm(Matrix<double>* C, Matrix<double>* A, Matrix<double>* b, double precision, string purpose, Matrix<double>* initial_point, double alpha)
{
    ...
    //Step 0: Construct initial feasible solution
    //For now, we are using the input initial point which is the vector initial_point
...
int main()
{
    ...
    cout << "Type the " << n+m << " numbers which constitute an initial trial solution that lies in the interior of feasible region:" << endl;
    cin >> initial_point;
